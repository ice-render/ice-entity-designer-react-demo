...
export const seedProject = {
  ...
  entities: [
    ...
    },
    {
      ...
      top: 60,
      entityName: 'Customer',
      fields: [pk(), str('name', 128, { nullable: false }), str('email', 128, { unique: true, nullable: false }), str('phone', 32, { nullable: true, comment: '联系电话' })],
    },
    {
      id: 'e-order',
      left: 860,
